    ...
    <>
      <nav className="fixed left-0 right-0 top-0 z-50 flex h-16 items-center justify-between border-b border-black/[0.06] bg-white/[0.94] px-6 backdrop-blur-[16px] sm:px-8">
        ...
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-lg transition-colors hover:bg-[#f0faf4] sm:hidden"
      ...
      {mobileOpen && (
        <div className="fixed left-0 right-0 top-16 z-40 flex flex-col gap-1 border-b border-[#e2e8f0] bg-white px-6 pb-5 pt-3 shadow-[0_8px_24px_rgba(0,0,0,0.08)] sm:hidden">
          <Link href="#topics" onClick={() => setMobileOpen(false)} className="flex min-h-[44px] items-center rounded-lg px-3 text-base font-medium text-[#0f1f14] transition-colors hover:bg-[#f0faf4] hover:text-[#198754]">
            Topics
          </Link>
          <Link href="#how" onClick={() => setMobileOpen(false)} className="flex min-h-[44px] items-center rounded-lg px-3 text-base font-medium text-[#0f1f14] transition-colors hover:bg-[#f0faf4] hover:text-[#198754]">
            How it works
          </Link>
