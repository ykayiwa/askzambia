    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <div className="flex h-16 items-center gap-2 border-b border-white/10 px-5">
          ...
          <div>
            <div className="text-sm font-semibold">AskZambia</div>
          ...
          {navItems.map((item) => (
            <Link
              ...
              className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${
                isActive(item.href)
                  ? "border-l-2 border-[#198754] bg-white/10 font-medium text-white"
        ...
        <div className="border-t border-white/10 p-4">
          <div className="flex items-center gap-3">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#198754] text-xs font-bold">
              A
            </div>
