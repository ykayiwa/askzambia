    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg bg-[#198754] px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#146c43]"
        >
          ...
          <form onSubmit={handleAdd} className="space-y-3">
            <div className="grid gap-3 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full rounded-md border border-gray-200 px-3 py-2 text-sm focus:border-[#198754] focus:outline-none focus:ring-1 focus:ring-[#198754]"
                />
              </div>
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-600">
            ...
            <label className="flex items-center gap-2 text-sm">
              <input
                ...
                className="h-4 w-4 rounded border-gray-300 text-[#198754] focus:ring-[#198754]"
              />
            ...
            <div className="flex gap-2">
              <button
                type="submit"
                className="rounded-md bg-[#198754] px-4 py-2 text-sm font-medium text-white hover:bg-[#146c43]"
              >
                Create Category
              </button>
              <button
            ...
            {editingId === cat.id ? (
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <span className="rounded-full bg-[#198754]/10 px-3 py-1 text-xs font-semibold text-[#198754]">
                    {cat.name}
                  </span>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="rounded-md bg-[#198754] px-4 py-2 text-xs font-medium text-white hover:bg-[#146c43]"
                  >
                    Save
                  </button>
                  <button
