...
export const metadata = {
  title: "Privacy Policy — AskZambia",
  description: "AskZambia privacy policy. Learn how we collect, use, and protect your data.",
};
      ...
      <header className="border-b border-[#e8ecf0] bg-white">
        <div className="mx-auto flex max-w-3xl items-center gap-2.5 px-6 py-4">
          <Link href="/" className="flex items-center gap-2.5">
            <ZambiaFlag size={28} />
            <span className="text-[0.95rem] font-bold tracking-tight text-[#198754]">
              AskZambia
            </span>
          </Link>
        </div>
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        ...
        <div className="mt-10 space-y-8 text-[0.9rem] leading-relaxed text-[#334155]">
          <section>
            ...
            <p>
              AskZambia (&quot;we&quot;, &quot;our&quot;, or &quot;the Platform&quot;) is a national AI
              knowledge platform that provides information about Zambia. This
              Privacy Policy explains how we collect, use, disclose, and
              safeguard your information when you use our website at
              askzambia.com and our mobile applications (collectively, the
              &quot;Service&quot;).
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc space-y-1.5 pl-5">
              ...
              <li>
                ...
                conversations you have with AskZambia. If you are signed in,
          ...
          <section>
            ...
            <p>
              You can use AskZambia without creating an account. When you use
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              <a
                href="mailto:privacy@askzambia.com"
                className="font-medium text-[#198754] underline underline-offset-2"
              >
                privacy@askzambia.com
              </a>
              .
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              AskZambia is not directed at children under 13. We do not
          ...
          <section>
            ...
            <div className="mt-3 rounded-xl border border-[#e8ecf0] bg-white p-4">
              <p className="font-semibold text-[#0f1f14]">AskZambia</p>
              <p className="mt-1">
                Email:{" "}
                <a
                  href="mailto:privacy@askzambia.com"
        ...
        <div className="mt-12 border-t border-[#e8ecf0] pt-6">
          <Link
            href="/"
            className="text-[0.85rem] font-medium text-[#198754] underline underline-offset-2"
          >
            &larr; Back to AskZambia
          </Link>
        </div>
      </main>
    </div>
